...
var ImageLoader = (function () {
    function ImageLoader(config, file, http, platform, httpCordova) {
        var _this = this;
        this.config = config;
        this.file = file;
        this.http = http;
        this.platform = platform;
        this.httpCordova = httpCordova;
        /**
        ...
        if (this.currentlyProcessing[currentItem.imageUrl] === undefined) {
            this.currentlyProcessing[currentItem.imageUrl] = new Promise(function (resolve, reject) {
                ...
                if (!_this.platform.is('cordova')) {
                    ...
                    _this.httpCordova.downloadFile(currentItem.imageUrl, {}, _this.config.httpHeaders, localDir + fileName).then(function (file) {
                        if (_this.isCacheSpaceExceeded) {
                            _this.maintainCacheSize();
                        }
                        _this.addFileToIndex(file).then(function () {
